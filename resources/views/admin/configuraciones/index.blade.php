            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/admin/configuraciones/create') }}" class="btn btn-info">Crear Nuevo</a>
                    </div>
                    ...
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            @foreach ($configuraciones as $configuracione)
                                <tr>
                                    <td class="text-center align-middle">{{$configuracione->id}}</td>
                                    <td class="align-middle">{{$configuracione->nombre}}</td>
                                    <td class="align-middle">{{$configuracione->descripcion}}</td>
                                    <td class="text-center align-middle">{{$configuracione->telefono}}</td>
                                    <td class="text-center align-middle">{{$configuracione->email}}</td>
                                    <td class="text-center align-middle">{{$configuracione->moneda}}</td>
                                    <td class="text-center align-middle"><img src="{{ asset('storage/' . $configuracione->logo) }}" width="30px" alt="imagen"></td>
                                    <td class="text-center align-middle">
                                        <div class="btn-group" role="group">
                                            <!-- Boton Ver -->
                                            <a href="{{ url('/admin/configuraciones/' . $configuracione->id) }}" 
                                            ...
                                            <!-- Boton Editar -->
                                            <a href="{{ url('/admin/configuraciones/' . $configuracione->id . '/edit') }}" 
